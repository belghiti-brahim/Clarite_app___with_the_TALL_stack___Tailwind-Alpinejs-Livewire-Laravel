         ...
         <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
             <div class="grid grid-cols-3 gap-6">
                 <div class="col-span-3 sm:col-span-2">
                     <label for="actionId"
                         class="block text-sm font-medium text-gray-700">{{ __('Action description') }}
                     </label>
             ...
             <div x-data x-init="flatpickr($refs.datetimewidget, { wrap: true, enableTime: false, dateFormat: 'Y-m-d', locale: 'en' });" x-ref="datetimewidget"
                 ...
                 <div class="flex align-middle align-content-center">
                     <input x-ref="datetime" id="datetime" data-input name="deadline" wire:model="deadline"
                         placeholder="Select.."
